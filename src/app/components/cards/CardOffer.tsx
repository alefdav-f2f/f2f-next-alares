...
export default function CardOffer({ offer, params }: any) {
    ...
    return (
        <div key={offer.id} className={`sm:scale-90 scale-75 rounded-lg sm:m-2 pb-4 h-full fade50 ${params === 'home-2-mob' ? '-mt-[80px]'  : ''}`}>
            <div className={`shadow-xl rounded-lg ${params === 'home-2' ? 'w-[280px]'  : ''} ${params === 'home-2-mob' ? 'w-[237px]'  : ''}`}>
