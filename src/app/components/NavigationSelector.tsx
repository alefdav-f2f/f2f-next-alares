...
export default function Navigation() {
  ...
  React.useEffect(() => {
    ...
    const titlesToRemove = ["Internet", "Serviços Adicionais", "Planos de Internet + TV"];

    const filteredNavList = navSecondyList?.filter((second) => 
    !titlesToRemove.includes(second.title)
    );
    ...
    <nav>
      <Drawer>
                    ...
                    <div className="hidden sm:flex justify-around w-full items-center">
                      ...
                      >
                        ...
                        <button onClick={() => {clearCookie()}} >
                            <div className="text-white hover:cursor-pointer rounded font-medium text-sm flex items-center py-1.5 px-4 border-main bg-main hover:bg-gray-100 hover:text-blue-700 focus:z-10 border-b-[4px] border-sub">
                                <span>{cityName || "Sua cidade"}</span>
                            </div>
                        </button>
                        {cityName?.length > 0 ? (
                          <>
            ...
            {/* Camada inferior de navegação */}
              ...
              <div className="hidden sm:flex justify-center items-center h-[70px] bg-white w-[100%]">
                <div className="flex items-center justify-center w-[1140px]">
                  {filteredNavList.map((second, index) => {
                    return (
                      <div>
                        {checkSecond(second) ? (
                          <div
        ...
        <DrawerContent className="bg-main">
          <div className="m-0 w-full max-w-sm h-[100vh]">
