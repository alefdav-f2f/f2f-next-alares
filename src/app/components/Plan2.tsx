          ...
          <section className="mb-20 max-w-[95vw] mx-auto">
            <div className="flex justify-between items-center pt-4 max-w-[1120px] mx-auto">
              ...
              <div
                ...
                className={`z-10 flex text-sm font-semibold hover:cursor-pointer px-2 sm:px-8 sm:py-4 max-[450px]:h-12 text-[#b8b8b8] border-[#b8b8b8] border-b-2 sm:border-2 sm:rounded-full bg-transparent items-center`}
              >
